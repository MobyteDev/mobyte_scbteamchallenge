...
class SelectCurrencyReceivePage extends StatefulWidget {
  const SelectCurrencyReceivePage({
    Key? key,
  }) : super(key: key);

  @override
  State<SelectCurrencyReceivePage> createState() =>
      _SelectCurrencyReceivePageState();
}

class _SelectCurrencyReceivePageState extends State<SelectCurrencyReceivePage> {
  @override
    ...
    return ScreenUtilInit(
      builder: (_, __) => MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
            create: (context) => context.watch<SellPageBloc>(),
          ),
        ],
                        ...
                        child: ListView(
                          ...
                          children: listCurrency
                              .map(
                                (e) => CurrencyElem(
                                  onTap: () {
                                //    context.read<SellPageBloc>().add(
                             //             SellPageEvent.changedCurrency2(
                               //               currency: e),
                                //        );
