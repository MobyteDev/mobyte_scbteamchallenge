...
class SelectCurrencyPayPage extends StatefulWidget {
  const SelectCurrencyPayPage({
    Key? key,
  }) : super(key: key);

  @override
  State<SelectCurrencyPayPage> createState() => _SelectCurrencyPayPageState();
}

class _SelectCurrencyPayPageState extends State<SelectCurrencyPayPage> {
  @override
                              ...
                              .map(
                                (e) => CurrencyElem(
                                  onTap: () {
                                    ...
                                    //            SellPageEvent.changedCurrency1(
                                    //             currency: e),
                                    //    );
                                  },
                                  name: e.name,
